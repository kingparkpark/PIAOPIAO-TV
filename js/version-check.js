...
async function checkForUpdates() {
    try {
        ...
        let latestVersion;
        const VERSION_URL = {
            PROXY: 'https://ghfast.top/raw.githubusercontent.com/LibreSpark/朴朴TV/main/VERSION.txt',
            DIRECT: 'https://raw.githubusercontent.com/LibreSpark/朴朴TV/main/VERSION.txt'
        };
            ...
            setTimeout(() => {
                ...
                if (updateBtn) {
                    updateBtn.addEventListener('click', () => {
                        window.open('https://github.com/LibreSpark/朴朴TV', '_blank');
                    });
                }
            }, 100);
        } else {
